...
export const welcome = () => {
  ...
  const generateParameterContent = () => {
    ...
    if (params) {
      weddingToElement.innerHTML = `Yth. Bapak/Ibu/Saudara/i<br><span>${params}</span>`;
      name.value = params;
    } else {
      weddingToElement.innerHTML = `Yth. Bapak/Ibu/Saudara/i<br><span>Teman-teman semua</span>`;
    }
  };
